...
LOG_DIR="$ROOT/logs"
SUMMARY="$LOG_DIR/lock3_m1_C8_C15_${STAMP}.summary.log"

mkdir -p "$LOG_DIR"
exec >> "$SUMMARY" 2>&1

echo "lock3 m1 C8-C15 batch start stamp=$STAMP"
echo "root=$ROOT"
echo "bin=$BIN"

for C in 8 9 10 11 12 13 14 15; do
...
echo "lock3 m1 C8-C15 batch complete stamp=$STAMP"
